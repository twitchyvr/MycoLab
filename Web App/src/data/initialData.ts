...
- Source URL and notes fields for citations`,
  ...
  },
  {
    ...
    actualHours: 6,
    completedAt: '2024-12-15',
    notes: 'Added LocationOccupancy component with real-time occupancy calculation from cultures and grows, strain/variety breakdown, container counts for grows (blocks), yield estimation per location, and hierarchical location display with expand/collapse. Accessible via new Occupancy nav item.',
  ...
  },
  {
    ...
    description: 'Predict when blocks need to move to next stage, forecast weight/yields, view 7-day harvest predictions. Includes 14-day calendar view, timeline mode, and confidence indicators.',
    category: 'core',
    status: 'completed',
    priority: 'high',
    estimatedHours: 12,
